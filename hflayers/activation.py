        ...
        if disable_out_projection:
            ...
            if bias and _LinearWithBias is not None:
                ...
                self.out_proj = Linear(
                    self.virtual_pattern_dim, self.out_dim, bias=bias
                )
    ...
    def forward(
        ...
        assert any(
            (
                ...
                self.value_as_static and value.shape[2] == self.pattern_dim,
                self.disable_out_projection,
            )
        ...
        if not self._qkv_same_embed_dim:
            return hopfield_core_forward(
                ...
                normalize_pattern_eps=self.normalize_pattern_eps,
